...
class _RestClient implements RestClient {
    ...
    final _result = await _dio.fetch<String>(_setStreamType<UserModel>(
        Options(method: 'POST', headers: _headers, extra: _extra)
            .compose(_dio.options,
                'https://ams-production-ae56.up.railway.app/api=auth/signin/',
  ...
  Future<String?> logout() async {
    ...
    final _result = await _dio.fetch<String>(_setStreamType<String>(
        Options(method: 'GET', headers: _headers, extra: _extra)
            .compose(_dio.options,
                'https://ams-production-ae56.up.railway.app/api=auth/signout/',
                queryParameters: queryParameters, data: _data)
            .copyWith(baseUrl: baseUrl ?? _dio.options.baseUrl)));
  ...
  Future<List<NoticeModel?>?> getNotices() async {
    ...
    final _result = await _dio.fetch<String>(_setStreamType<String>(
        Options(method: 'GET', headers: _headers, extra: _extra)
            .compose(_dio.options,
                'https://ams-production-ae56.up.railway.app/api=notice/get_all/',
                queryParameters: queryParameters, data: _data)
            .copyWith(baseUrl: baseUrl ?? _dio.options.baseUrl)));
  ...
  Future<String?> postFeedback(String title, String description) async {
    ...
    final _result = await _dio.fetch<String>(_setStreamType<String>(
        Options(method: 'POST', headers: _headers, extra: _extra)
            .compose(_dio.options,
                'https://ams-production-ae56.up.railway.app/api=feedback/post/',
                queryParameters: queryParameters, data: _data)
            .copyWith(baseUrl: baseUrl ?? _dio.options.baseUrl)));
    final value = _result.data;
    return value;
  ...
  Future<String?> getRoutine(String uid) async {
    ...
    final _result = await _dio.fetch<String?>(_setStreamType<String?>(
        Options(method: 'POST', headers: _headers, extra: _extra)
            .compose(_dio.options,
                'https://ams-production-ae56.up.railway.app/api=routine/get_all/',
                queryParameters: queryParameters, data: _data)
            .copyWith(baseUrl: baseUrl ?? _dio.options.baseUrl)));
    final value = _result.data;
    return value;
